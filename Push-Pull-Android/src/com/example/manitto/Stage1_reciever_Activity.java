...
public class Stage1_reciever_Activity extends Activity implements OnClickListener {
	...
	public void game_start(){
		...
		game_start_popup.setTitle("Stage 1 Mission");
		game_start_popup.setMessage("Now we start Push&Pull Game!! You are Pusher.\n Stage 1 Misson is to have 100 intimacy Point.\n " +
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				gameTimer = new CountDownTimer(121000, 1000){
					...
					public void onFinish() {
						...
						chat.socketClose();
						Stage1_reciever_Activity.this.finish();
	...
	public void game_end(){
		...
		game_end_popup.setPositiveButton("Go Next Stage!!", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				// TODO Auto-generated method stub
				Intent myIntent = new Intent(getApplicationContext(), Stage2_reciever_Activity.class);
