...
public class Stage2_reciever_Activity extends Activity implements OnClickListener {
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		if(v==btn){
			...
			menu.add(0,5,0, "Give Ur Profile");
		}
	}
	...
	public void game_start(){
		...
		game_start_popup.setMessage("Now we start Stage 2!! You are Pusher.\n Stage 2 Misson is to have 100 intimacy Point.\n " +
				"You can give a point if you like Conversation with Puller.\n Also you have to upload your detail Profile\n" +
				"You can give Points for 10 times!" +
				"If you want to continue the game, having a conversation with Puller and give some Points for him/her to get 100 Intimacy Points!!" +
				"if Puller confirm your Profile, this Stage ends!!\n"+
				"So good Luck!");
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				gameTimer = new CountDownTimer(121000, 1000){
					...
					public void onFinish() {
						...
						chat.socketClose();
						Stage2_reciever_Activity.this.finish();
