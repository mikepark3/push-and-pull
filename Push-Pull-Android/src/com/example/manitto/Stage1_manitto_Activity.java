...
public class Stage1_manitto_Activity extends Activity implements OnClickListener {
	...
	public void game_start(){
		...
		game_start_popup.setMessage("Now we start Push&Pull Game!! You are Puller.\n Stage 1 Misson is to have 100 intimacy Point.\n " +
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				gameTimer = new CountDownTimer(121000, 1000){
					...
					public void onFinish() {
						...
						chat.socketClose();
						Stage1_manitto_Activity.this.finish();
	...
	public void game_end(){
		...
		game_end_popup.setPositiveButton("Go Next Stage!!", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				// TODO Auto-generated method stub
				Intent myIntent = new Intent(getApplicationContext(), Stage2_manitto_Activity.class);
